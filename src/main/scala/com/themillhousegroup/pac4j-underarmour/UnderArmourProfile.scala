...
class UnderArmourProfile extends OAuth20Profile {
	  ...
	  val UNDERARMOUR_SELF_PROFILE_URL = "https://api.ua.com/v7.1/user/self/"
    ...
    override def getPictureUrl:String = {
        getString(UnderArmourAttributesDefinition.PROFILE)
    }

    override val getProfileUrl:String = UNDERARMOUR_SELF_PROFILE_URL

    override def getLocation:String = {
        getString(UnderArmourAttributesDefinition.CITY)
    }
    ...
    def getProfileMedium:String = {
        getString(UnderArmourAttributesDefinition.PROFILE_MEDIUM)
    }

    def getState:String = {
        getString(UnderArmourAttributesDefinition.STATE)
    }
